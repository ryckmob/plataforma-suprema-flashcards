import { faBrain, faChartSimple, faCircleQuestion, faFile } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      ...
      <div className="px-4 flex flex-col mt-4">
        ...
        <div className="bg-gradient-to-br from-[#16213e] to-[#7f4d22] w-full min-h-16 mt-3 rounded-lg p-4 flex flex-col">
          ...
          <span className="text-gray-200 text-md text-left">
            Sua próxima revisão está pronta: <br /> 15 cards + 5 questões + 1 caso prático
          </span>
          <button className="bg-[#bc853a] p-3 rounded-lg font-bold m-3">
            Iniciar Revisão Suprema
          </button>
        </div>
      </div>
    </>
